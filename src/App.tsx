...
function App() {
  ...
  return <svg id="svg" width="650" height="600" viewBox="0 0 650 600"></svg>; // works!
  // return <svg id="svg" width="650" height="600" viewBox="0 0 1000 600"></svg>; // does not work :-(
}
